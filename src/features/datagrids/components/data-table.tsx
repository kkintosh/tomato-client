...
export const columns: ColumnDef<File>[] = [
  ...
  },
  {
    ...
    header: "Size",
    cell: ({ row }) => <div className="capitalize">{formatBytes(row.getValue("fileSize"))}</div>,
  },
  {
    accessorKey: "lastUpdateDateTime",
    header: "Last updated",
    cell: ({ row }) => <div>{shortenDateTime(row.getValue("lastUpdateDateTime"))}</div>,
  },
